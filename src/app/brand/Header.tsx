      ...
      <div className="w-full max-w-md">
        <div className="bg-card/50 backdrop-blur-lg border border-border rounded-full shadow-lg p-2 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-1 text-sm font-medium text-muted-foreground">
            <Link href="/subscriber" className="px-3 py-1.5 hover:text-foreground transition-colors rounded-full">
              Connect
            </Link>
            <Link href="/freelancer" className="px-3 py-1.5 hover:text-foreground transition-colors rounded-full">
              Work
            </Link>
            <Link href="/brand" className="px-3 py-1.5 hover:text-foreground transition-colors rounded-full">
              Brands
            </Link>
          </nav>
          <div className="pr-1">
